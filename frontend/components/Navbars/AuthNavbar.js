              ...
              <li className="flex items-center">
                <Link href="/auth/login">
                  <a
                    ...
                    href="#"
                  >
                    <i className="lg:text-blueGray-200 text-blueGray-400 fa fa-sign-in text-lg leading-lg " />
              ...
              <li className="flex items-center">
                <Link href="/auth/register">
                  <a
                    ...
                    href="#"
                  >
                    <i className="lg:text-blueGray-200 text-blueGray-400 fa fa-sign-i-alt text-lg leading-lg " />
